...
class ksketchsvg:
    ...
    def get_visibility_keys(kobject):
        ...
        for visibility_key in kobject.findall('.//visibilitykey'):   #List of ElementTree in document order
            ...
            #d['v'] = int(bool(visibility_key.attrib['visibility']))
    ...
    def get_object_timeline(kobject):
        ...
        while cur_time < last_time + 1:
            ...
            #print "get_object_timeline: obj %d, time %s, prev (%.1f,%.1f,%.1f,%.1f,%d), cur (%.1f,%.1f,%.1f,%.1f,%d)" % \
            #      (id, ksketchsvg.time_to_key(cur_time), prev_frame['x'], prev_frame['y'], prev_frame['r'],
            #       prev_frame['s'], prev_frame['v'], cur_frame['x'], cur_frame['y'], cur_frame['r'], cur_frame['s'],
            #       cur_frame['v'])
    ...
    # @staticmethod
    # def get_transformations_old(xml):
    #
    #     root = ET.fromstring(xml)
